...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_backstage_passes_quality_rise_normal(self, sell_in_init, sell_in_expected, quality_init, quality_expected):
        item = BackstagePasses("Backstage passes to a TAFKAL80ETC concert", sell_in_init, quality_init, quality_change=1)
        item.update_item()
        self.assertEqual(sell_in_expected, item.sell_in)
        self.assertEqual(quality_expected, item.quality)
